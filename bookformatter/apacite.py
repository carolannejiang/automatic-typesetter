...
def chapter_source_entries(chapters) -> list:
    """Provenance entries for chapters ingested from the web, in book order:
    each chapter's own author, date, and title cited at its source URL — no
    fetching, the metadata came with ingestion."""
    out = []
