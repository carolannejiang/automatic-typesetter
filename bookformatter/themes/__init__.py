...
from . import base, classic, classical, classicthesis, modern, shortintro, tufte, vsi
from .base import TRIM_SIZES

_THEME_MODULES = (classic, modern, classical, vsi, classicthesis, shortintro, tufte)
